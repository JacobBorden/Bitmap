...
void check_bgra_to_rgba_conversion(size_t num_pixels) {
    ...
    if (num_pixels == 0) {
        internal_swizzle_bgra_to_rgba_simd(nullptr, nullptr, 0);
        SUCCEED();
        return;
    }
    ...
    internal_swizzle_bgra_to_rgba_simd(bgra_input.data(), rgba_output.data(), num_pixels);
...
void check_rgba_to_bgra_conversion(size_t num_pixels) {
    ...
    if (num_pixels == 0) {
        internal_swizzle_rgba_to_bgra_simd(nullptr, nullptr, 0);
        SUCCEED();
        return;
    }
    ...
    internal_swizzle_rgba_to_bgra_simd(rgba_input.data(), bgra_output.data(), num_pixels);
